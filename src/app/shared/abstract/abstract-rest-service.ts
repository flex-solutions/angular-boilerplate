...
export abstract class AbstractRestService {
    ...
    constructor() {
        ...
        this.configurationService = SharedModule.injector.get(ApplicationConfigurationService);
    ...
    private handleError(error: HttpErrorResponse) {
        ...
        if (errorMsg && errorMsg.message && errorMsg.message.message) {
            ...
            const displayError = errorMsg.message.message.content[this.translateService.currentLocale];
            if (displayError) {
                switch (messageType) {
                    case 0:
                        ...
                        this.browserNotifer.generateNotification([
                            {
                                title: this.translateService.translate('notification-browser-title-success'),
                    ...
                    case 1:
                        ...
                        this.browserNotifer.generateNotification([
                            {
                                title: this.translateService.translate('notification-browser-title-info'),
                                alertContent: displayError
                            }
                        ]);
                        break;
                    case 2:
                        ...
                        this.browserNotifer.generateNotification([
                            {
                                title: this.translateService.translate('notification-browser-title-warning'),
                                alertContent: displayError
                            }
                        ]);
                        break;
                    case 3:
                        ...
                        this.browserNotifer.generateNotification([
                            {
                                title: this.translateService.translate('notification-browser-title-error'),
                                alertContent: displayError
                            }
                        ]);
                        break;
